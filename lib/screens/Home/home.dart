...
class _HomePage extends State<HomeState> {
    ...
    return new MaterialApp(
      ...
      home: DefaultTabController(
        ...
        child: new Scaffold(
          ...
          floatingActionButton: Observer(builder: (ctx) {
  ...
  _renderListTasksUndone() {
    return Observer(builder: (ctx) {
      ...
      var listFiltered = _taskService.taskStore.tasks
          .where((element) => !element.done)
          .toList();

      if (listFiltered == null || listFiltered.isEmpty) {
        return Center(
          child: Text("Sem tarefas em andamento para exibir"),
        );
      }
      return ListView(
  ...
  _renderListTasksDone() {
    return Observer(builder: (ctx) {
      ...
      if (listFiltered == null || listFiltered.isEmpty) {
        return Center(
          child: Text("Sem tarefas concluidas para exibir"),
        );
      }
      return ListView(
        children: listFiltered.map((task) {
