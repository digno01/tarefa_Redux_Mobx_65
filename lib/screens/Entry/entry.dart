          ...
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.only(
                  bottom: 0.0, left: 30, right: 30, top: 0.0),
              child: TextField(
                onChanged: (name) {
                  this._name = name;
                },
                ...
                decoration: InputDecoration(
                  border: new UnderlineInputBorder(
                      borderSide: new BorderSide(
                          color: Color.fromRGBO(246, 246, 246, 0), width: 1)),
                  labelStyle: new TextStyle(color: Colors.green),
                  hintStyle: TextStyle(color: Color.fromRGBO(51, 51, 51, 1)),
                ),
              ),
            ),
            ...
            Padding(
              padding: const EdgeInsets.only(
                  left: 30, bottom: 0, top: 15, right: 30),
